...
4. Type-prefixes currently authorized (update this list when adding or removing a type-prefix):
   ...
   - **Policies** — `pl_` is **required** for every file under `docs/policies/`, including files nested in `docs/policies/domain_policies/`. Example: `pl_001_file_and_folder_naming_convention.md`. See `docs/policies/domain_policies/pl_001_all_policy_filenames_use_pl_prefix.md`.
...
- `pl_001_file_and_folder_naming_convention.md` (policy — `pl_` required)
- `pl_002_item_numbering_convention.md` (policy — `pl_` required)
